...
class DreamRecorderViewTest(TestCase):
    ...
    def test_dream_recorder_view_authenticated(self):
        ...
        """
        self.client.login(
            email="recorder@example.com", password=TEST_USER_PASSWORD
        )
...
class DreamFollowupViewTest(TestCase):
    ...
    def test_dream_followup_view_default(self, mock_themes):
        ...
        mock_themes.return_value = {
            "themes": {"Émotions mixtes": {"count": 2, "percentage": 100.0}},
            "total_dreams": 2,
            "top_theme": {
                "name": "Émotions mixtes",
                "count": 2,
                "percentage": 100.0,
            },
            "has_data": True,
        ...
        self.client.login(
            email="followup@example.com", password=TEST_USER_PASSWORD
        )
    ...
    def test_dream_followup_view_performance(self, mock_themes):
        ...
        mock_themes.return_value = {
            "themes": {
                "Performance test": {"count": 30, "percentage": 60.0},
                "Thème secondaire": {"count": 20, "percentage": 40.0},
            },
            "total_dreams": 50,
            "top_theme": {
...
class ViewsSecurityTest(TestCase):
    ...
    def test_csrf_protection_on_forms(self):
        ...
        """
        self.client.login(
            email="security@example.com", password=TEST_USER_PASSWORD
        )
