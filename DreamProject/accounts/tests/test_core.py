...
class CoreAuthenticationTest(TestCase):
    ...
    def test_user_can_login_with_email(self):
        ...
        user = authenticate(
            email="auth@example.com", password=TEST_USER_PASSWORD
        )
    ...
    def test_user_cannot_login_with_wrong_password(self):
        ...
        user = authenticate(
            email="auth@example.com", password="wrong_password"
        )
...
class CoreFormsTest(TestCase):
    ...
    def test_register_form_valid_data(self):
        ...
        user = form.save()
        print(
            f"User created: {user.email}, age: {user.age}, bio: '{user.bio}'"
        )
    ...
    def test_register_form_with_optional_fields(self):
        ...
        user = form.save()
        print(
            f"User saved - email: {user.email}, date_of_birth: {user.date_of_birth}, sexe: {user.sexe}"
        )
...
class CoreViewsTest(TestCase):
    ...
    def test_register_view_loads(self):
        ...
        self.assertContains(
            response, "email"
        )  # Le formulaire contient un champ email
        self.assertContains(
            response, "password"
        )  # Le formulaire contient un champ password
    ...
    def test_register_post_creates_user(self):
        ...
        print(
            f"Response redirect URL: {getattr(response, 'url', 'No redirect')}"
        )
        ...
        print(
            f"User details: email={user.email}, age={user.age}, bio='{user.bio}'"
        )
    ...
    def test_logout_works(self):
        ...
        self.client.login(
            email="views@example.com", password=TEST_USER_PASSWORD
        )
...
class CoreSecurityTest(TestCase):
    ...
    def test_sql_injection_protection(self):
        ...
        form_data = {"email": malicious_email, "password": TEST_USER_PASSWORD}
