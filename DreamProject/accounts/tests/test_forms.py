...
class LoginFormTest(TestCase):
    ...
    def test_login_form_missing_email(self):
        ...
        """
        form_data = {"password": TEST_USER_PASSWORD}
    ...
    def test_login_form_missing_password(self):
        ...
        """
        form_data = {"email": "logintest@example.com"}
    ...
    def test_login_form_case_sensitivity(self):
        ...
        self.assertIn(
            cleaned_email.lower(),
            ["logintest@example.com", "LOGINTEST@EXAMPLE.COM"],
        )
...
class CustomPasswordChangeFormTest(TestCase):
    ...
    def test_password_change_form_weak_new_password(self):
        ...
        has_password_error = (
            "new_password1" in form.errors
            or "new_password2" in form.errors
    ...
    def test_password_change_form_labels(self):
        ...
        self.assertEqual(
            form.fields["old_password"].label, "Ancien mot de passe"
        )
        self.assertEqual(
...
class BioFormTest(TestCase):
    ...
    def test_bio_form_valid_update(self):
        ...
        """
        form_data = {"bio": "Nouvelle bio mise à jour"}
...
class FormSecurityTest(TestCase):
    ...
    def test_form_field_lengths_protection(self):
        ...
        form_data = {"email": very_long_email, "password": TEST_USER_PASSWORD}
...
class FormValidationEdgeCasesTest(TestCase):
    ...
    def test_register_form_boundary_birth_dates(self):
        ...
        self.assertTrue(
            form.is_valid(),
            f"Utilisateur de plus de 13 ans doit être accepté: {form.errors}",
        )
        ...
        for invalid_data in invalid_data_types:
            with self.subTest(data=invalid_data):
                ...
                try:
                    ...
                    self.fail(
                        f"Le formulaire ne devrait pas lever d'exception avec {invalid_data}: {e}"
                    )
